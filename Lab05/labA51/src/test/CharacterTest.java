...
public class CharacterTest {
    ...
    public void characterShouldMoveToTheRightAfterTheRightKeyIsPress() throws IllegalAccessException, InvocationTargetException, InvocationTargetException {
        ...
        assertTrue("Model: Character moving Right state is set", characterListUnderTest.get(0).isMoveRight());
        assertTrue("View: Character is moving Right", characterListUnderTest.get(0).getX() > characterListUnderTest.get(0).getStartX());
    }
