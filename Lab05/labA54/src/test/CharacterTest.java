...
public class CharacterTest {
    ...
    @Test
    public void characterCannotPassedTheInvisibleWallThatCreatorJustCreateThatMeanCharacterInTheCageSorryMario() throws IllegalAccessException, InvocationTargetException, InvocationTargetException {
        platformUnderTest.getKeys().add(KeyCode.D);
        updateMethod.invoke(gameLoopUnderTest,characterListUnderTest);
        redrawMethod.invoke(drawingLoopUnderTest,characterListUnderTest);
