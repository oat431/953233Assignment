...
public class CharacterPane extends ScrollPane {
    ...
    private Pane getDetailsPane() {
        ...
        if (this.character != null) {
            ...
            /* 1.4.7.4 begin
            * the code below is check either the EquippedPane is empty or not and if the EquippedPane ready it will
            * plus the attribute of the Weapon and Armor to based Attribute of the main Character
            * */
