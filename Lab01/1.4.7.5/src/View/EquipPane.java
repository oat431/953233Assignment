...
public class EquipPane extends ScrollPane {
    ...
    private Pane getDetailsPane() {
        ...
        /* add 1.4.7.5
        *  two button one is for unequipped weapon and another is for armor
        * */
        Button unEquipWeapon = new Button();
        Button unEquipArmor = new Button();
        Button unEquipAll = new Button();

        unEquipWeapon.setText("unequipped");
        unEquipArmor.setText("unequipped");
        unEquipAll.setText("unequipped All");

        unEquipWeapon.setOnAction(new AllCustomHandler.UnequippedWeapon());
        unEquipArmor.setOnAction(new AllCustomHandler.UnequippedArmor());
        unEquipAll.setOnAction(new AllCustomHandler.UnequippedAll());
        /* 1.4.7.5 ended */
        equipmentInfoPane.getChildren().addAll(weaponLbl, weaponImgGroup, unEquipWeapon, armorLbl, armorImgGroup,unEquipArmor,unEquipAll);
