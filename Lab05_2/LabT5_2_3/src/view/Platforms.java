...
public class Platforms extends Pane {
    ...
    public Platforms(){
        ...
        this.specialPoint = this.rand.nextInt(5)+5;
    }

    public void render(Snake snake, Food food, SpecialFood sp){
        ...
        if(Integer.parseInt(getScore())%7 == 1){
            gc.setFill(Color.GREEN);
            gc.fillRect(sp.getPosition().getX() * TILE_SIZE, sp.getPosition().getY() * TILE_SIZE, TILE_SIZE, TILE_SIZE);
        }
    }
