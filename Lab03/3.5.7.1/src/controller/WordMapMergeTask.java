...
public class WordMapMergeTask implements Callable<LinkedHashMap<String,ArrayList<FileFreq>>> {
    ...
    public LinkedHashMap<String,ArrayList<FileFreq>> call() {
        ...
        uniqueSets = (LinkedHashMap<String, ArrayList<FileFreq>>) wordMapList.stream()
                ...
                .entrySet()
                .stream()
                .sorted(Map.Entry.comparingByValue(new SortByValue().reversed()))
                .collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue, (v1, v2) -> v1, LinkedHashMap::new));
        System.out.println(uniqueSets.values().size());
        return uniqueSets;
    }
